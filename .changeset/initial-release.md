---
'@joihouse/magnet-cursor-core': minor
'@joihouse/magnet-cursor-react': minor
'@joihouse/magnet-cursor-vue': minor
---

Initial release: a trailing magnetic cursor and magnetic hover elements, with a framework-agnostic
